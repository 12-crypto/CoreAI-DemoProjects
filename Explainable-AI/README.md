...
This project implements and compares three state-of-the-art visual explanation methods (Grad-CAM, Grad-CAM++, and Score-CAM) for interpreting ResNet50 predictions on the Intel Image Classification dataset, providing insights into model decision-making processes for 6 scene categories (buildings, forest, glacier, mountain, sea, street).

### 1.2. Original Project Details

- Author: [Eiji Ito](https://www.kaggle.com/itoeiji)
- License: [Apache 2.0 open source license](https://www.apache.org/licenses/LICENSE-2.0)
- Notebook: [Visual explanations GradCAM / GradCAM++ / ScoreCAM](https://www.kaggle.com/code/itoeiji/visual-explanations-gradcam-gradcam-scorecam/notebook)
